...
<footer class="footer-widget-section">
    ...
    <div class="footer-copy">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">&copy; 2021 <a href="#">My blog on Yii2, </a> Code in my <a class="fa fa-github" href="https://github.com/aleks-jpg/blogOnYii2">Repository on GitHub</a>
                    </div>
                </div>
            </div>
        </div>
